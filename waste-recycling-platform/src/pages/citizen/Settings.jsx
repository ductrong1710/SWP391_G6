...
const Settings = () => {
  ...
  return (
    <div className="settings-container fade-in">
      ...
      {/* 2. Bộ 3 Tab chuyển đổi (General - Security - Preferences) */}
      ...
      {/* 3. Nội dung Tab General (Giống hệt ảnh mẫu) */}
      {activeTab === 'general' && (
        <div className="tab-pane">
          <h3 className="pane-title">Profile Information</h3>
          <p className="text-gray-sm">Update your personal details and profile picture</p>
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-input" defaultValue="jane.doe@example.com" />
            </div>
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-input bg-gray" defaultValue="Citizen" disabled />
            </div>
...
{activeTab === 'security' && (
  ...
  <div className="tab-pane">
    ...
    <div className="toggle-item">
      ...
      <label className="switch">
        <input type="checkbox" defaultChecked /> {/* Mặc định Bật */}
        <span className="slider round"></span>
      </label>
    </div>
    ...
    <div className="toggle-item" style={{borderTop: 'none', borderTopLeftRadius: 0, borderTopRightRadius: 0}}>
      ...
      <label className="switch">
        <input type="checkbox" /> {/* Mặc định Tắt */}
        <span className="slider round"></span>
      </label>
    </div>
