...
const Rules = () => {
  ...
  const fetchWasteTypes = async () => {
    try {
      ...
      // Mock: Set some as accepted by default
      setAcceptedWasteTypes([1, 2, 3]); // IDs của Plastic, Electronics, Metal
    } catch (err) {
  ...
  const fetchSettings = () => {
    // Mock settings - trong thực tế sẽ fetch từ API
    setPointMultipliers([
      { wasteTypeId: 1, wastetype: { name: 'Plastic' }, quality: 'High', multiplier: 2.0 },
      { wasteTypeId: 1, wastetype: { name: 'Plastic' }, quality: 'Medium', multiplier: 1.5 },
      { wasteTypeId: 2, wastetype: { name: 'Electronics' }, quality: 'Working', multiplier: 3.0 },
      { wasteTypeId: 3, wastetype: { name: 'Paper' }, quality: 'Clean', multiplier: 1.8 },
      { wasteTypeId: 4, wastetype: { name: 'Metal' }, quality: 'High', multiplier: 2.5 }
    ]);
  };
  ...
  const handleAddMultiplier = () => {
    if (!newMultiplier.wasteTypeId || !newMultiplier.quality || !newMultiplier.multiplier) {
      setError('❌ Vui lòng điền đầy đủ thông tin');
      setTimeout(() => setError(''), 3000);
      return;
    }

    const wasteType = allWasteTypes.find(wt => wt.wasteTypeId === parseInt(newMultiplier.wasteTypeId));
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      // Mock API call - trong thực tế sẽ gọi API để lưu settings
    ...
    <div className="rules-container">
      ...
      <div className="rules-grid">
        ...
        <div className="settings-card">
          ...
          <p className="card-description">Set your daily collection limits and preferences</p>
              ...
              {allWasteTypes.map(wasteType => (
                <label key={wasteType.wasteTypeId} className="checkbox-card">
                  <input
                    ...
                    onChange={() => handleToggleWasteType(wasteType.wasteTypeId)}
                  />
          ...
          <div className="setting-group">
            <label className="toggle-label">
              ...
              <span className="toggle-text">
                Auto-assign Collectors
                <small>Automatically assign available collectors to requests</small>
              </span>
            </label>
          </div>
          ...
          <div className="setting-group">
            ...
            <p className="setting-hint">
              Requests with AI priority scores above this threshold will be automatically accepted
            </p>
          </div>
        </div>
        ...
        <div className="settings-card">
          ...
          <p className="card-description">Configure bonus multipliers for different waste types and qualities</p>
            ...
            {pointMultipliers.map((multiplier, index) => (
              <div key={index} className="multiplier-item">
                <div className="multiplier-info">
                  <span className="multiplier-type">{multiplier.wastetype?.name}</span>
                  <span className="multiplier-quality">{multiplier.quality}</span>
                </div>
                <div className="multiplier-value-container">
                  <span className="multiplier-value">{multiplier.multiplier}x</span>
                  <button
          ...
          <div className="add-multiplier-form">
            ...
            <div className="form-row">
              <select
                ...
                onChange={(e) => setNewMultiplier({ ...newMultiplier, wasteTypeId: e.target.value })}
              ...
              <select
                ...
                onChange={(e) => setNewMultiplier({ ...newMultiplier, quality: e.target.value })}
                className="form-select"
              >
      ...
      <div className="info-cards">
        <div className="info-card">
          ...
          <div className="info-content">
            ...
            <p>
              Citizens earn base points for each waste collection. Multipliers increase rewards based on
              waste type and quality. For example, high-quality plastic gets 2x points.
            </p>
          </div>
        </div>
        ...
        <div className="info-card">
          ...
          <div className="info-content">
            ...
            <p>
              When enabled, the system automatically assigns the nearest available collector to new requests.
              This reduces response time and improves efficiency.
            </p>
          </div>
        </div>
        ...
        <div className="info-card">
          ...
          <div className="info-content">
            ...
            <p>
              The AI scoring system evaluates each report. High-priority requests (above threshold)
              are automatically approved to ensure quick response to urgent situations.
            </p>
          </div>
        </div>
      </div>
