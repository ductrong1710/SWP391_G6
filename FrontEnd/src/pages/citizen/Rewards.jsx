...
import rewardService from "../../services/rewardService"; // Import service

const Rewards = () => {
  const [activeFilter, setActiveFilter] = useState("All");
  const [userPoints, setUserPoints] = useState(0); // Khởi tạo bằng 0
  const [selectedReward, setSelectedReward] = useState(null);

  // Lấy điểm thật từ Database khi vào trang
  useEffect(() => {
    rewardService.getMyBalance()
      .then(res => setUserPoints(res.totalPoints || 0))
  ...
  // ✅ ĐÃ THÊM MẢNG FILTERS BỊ THIẾU Ở ĐÂY
  const filters = [
    "All",
    "Food & Drink",
    "Shopping",
